...
function updateGallery(movement) {
	...
	;[galleryPosition - 1, galleryPosition, galleryPosition + 1].forEach(
		(position) => {
			...
			img.src = src
			img.className = 'bp-image shadow-cover'
...
function open(err) {
	...
	setTimeout(() => {
		displayElement.classList.add('bp-image', 'shadow-cover') // FV
